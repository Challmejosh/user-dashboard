...
const SideBar = () => {
  ...
  return (
    ...
    >
      {/* toggle button */}
      {!isShow ? (
        <div title="expand" className="bg-[#5932EA] w-fit cursor-pointer absolute right-[-10px] top-[20px] rounded-full ">
            <ChevronRight
            onClick={toggleShow}
          ...
          <div title="collapse" className="bg-[#5932EA] w-fit cursor-pointer absolute right-[-10px] top-[20px] rounded-full ">
            <ChevronLeft
              onClick={toggleShow}
              className="cursor-pointer "
              />
